...
export class Coupon extends BaseEntity {
  ...
  get type(): CouponType { return this._type; }
  get value(): number { return this._value; }
  get minPurchase(): number | null { return this._minPurchase; }
  get maxDiscount(): number | null { return this._maxDiscount; }
  get maxUses(): number | null { return this._maxUses; }
  get maxUsesPerUser(): number | null { return this._maxUsesPerUser; }
  ...
  update(props: {
    ...
    if (props.maxUsesPerUser !== undefined) this._maxUsesPerUser = props.maxUsesPerUser;
