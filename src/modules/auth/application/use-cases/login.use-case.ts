...
export class LoginUseCase {
  ...
  async execute(dto: LoginDto): Promise<AuthTokensResponseDto> {
    ...
    if (!user) throw new DomainUnauthorizedException(ErrorMessages.INVALID_CREDENTIALS);
    ...
    if (!valid) throw new DomainUnauthorizedException(ErrorMessages.INVALID_CREDENTIALS);
