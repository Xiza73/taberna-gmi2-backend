...
const CARRIER_TEMPLATES: Record<string, string> = {
  ...
  [Carrier.SERPOST]: 'https://tracking.serpost.com.pe/tracking/{trackingNumber}',
  [Carrier.OLVA]: 'https://www.olvacourier.com/rastreo/{trackingNumber}',
  [Carrier.DHL]: 'https://www.dhl.com/pe-es/home/rastreo.html?tracking-id={trackingNumber}',
};

export class TrackingUrlGenerator {
  generate(carrier: Carrier, trackingNumber: string, customUrl?: string): string {
