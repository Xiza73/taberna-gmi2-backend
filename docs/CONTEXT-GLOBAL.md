...
| Role | Alcance |
|------|---------|
| **customer** | Navegar catalogo, carrito, wishlist, checkout, pagar, ver ordenes, reviews, gestionar perfil/direcciones |
| **admin** | Todo lo anterior + CRUD productos/categorias/banners/cupones, gestionar ordenes/envios/usuarios, dashboard, logs (Kibana) |
...
| 3 | Users | Full DDD | [users.md](modules/users.md) |
| 4 | Categories | Full DDD | [categories.md](modules/categories.md) |
| 5 | Products | Full DDD | [products.md](modules/products.md) |
| 6 | Banners | Full DDD | [banners.md](modules/banners.md) |
| 7 | Cart | Full DDD | [cart.md](modules/cart.md) |
| 8 | Addresses | Full DDD | [addresses.md](modules/addresses.md) |
| 9 | Coupons | Full DDD | [coupons.md](modules/coupons.md) |
| 10 | Orders | Full DDD | [orders.md](modules/orders.md) |
| 11 | Payments | Full DDD | [payments.md](modules/payments.md) |
| 12 | Shipping | Full DDD | [shipping.md](modules/shipping.md) |
| 13 | Reviews | Full DDD | [reviews.md](modules/reviews.md) |
| 14 | Admin | Orchestration | [admin.md](modules/admin.md) |
| 15 | Wishlist | Full DDD | [wishlist.md](modules/wishlist.md) |
| 16 | Uploads | Full DDD | [uploads.md](modules/uploads.md) |
| 17 | Notifications | @Global Infrastructure | [notifications.md](modules/notifications.md) |
| 18 | Logging | Middleware en Shared | [logging.md](modules/logging.md) |
| 19 | Search | Full DDD | [search.md](modules/search.md) |
...
9. Admin: POST /admin/orders/:id/shipment (registra envio) → Email con tracking
10. Customer: GET /orders/:id (ve tracking URL del carrier)
11. Admin: PATCH shipment → delivered → Email pedido entregado
...
-- shipping_address_snapshot es NOT NULL (toda orden requiere direccion)
